...
namespace TestContent.Projectiles.Weapons
{
    public class TestSwordProjectile : ModProjectile
    {
        ...
        public override string Texture => "TestContent/Items/Weapons/TestSword"; // Use texture of item as projectile texture
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Vector2 rotationOffsetV = (Projectile.rotation - rotV).ToRotationVector2() * (Projectile.Size.Length() * Projectile.scale) * 0.6f;
            ...
            Main.spriteBatch.Draw(texture, pos - rotationOffsetV, default, drawColor * Projectile.Opacity, Projectile.rotation + rotationOffset, origin, Projectile.scale, effects, 0);
        ...
        public void SpawnDust()
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                int dust = Dust.NewDust(line, 0, 0, DustID.Torch, SpeedX: dir.X * randSpeedMod, SpeedY: dir.Y * randSpeedMod, Scale: Main.rand.NextFloat(0.5f, 2f));
