    ...
    public static class PrimitiveRenderer
    {
        ...
        private static void PrivateRender()
        {
            ...
            if (MainSettings.Pixelate)
                ...
                GraphicsUtils.CalculatePerspectiveMatricies(out view, out projection);

            var shaderToUse = MainSettings.Shader ?? GameShaders.Misc["TestContent:StandardPrimitiveShader"];
