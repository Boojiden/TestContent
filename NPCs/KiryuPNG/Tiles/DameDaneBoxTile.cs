...
namespace TestContent.NPCs.KiryuPNG.Tiles
{
    public class DameDaneBoxTile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(255, 215, 191), Language.GetText("Mods.TestContent.Items.DameDaneBoxItem.DisplayName"));
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<DameDaneBoxItem>();
        }
