...
{
    public class KiryuBossRelic : ModTile
    {
        ...
        public virtual string RelicTextureName => "TestContent/NPCs/KiryuPNG/Tiles/KiryuBossRelic";

        // All relics use the same pedestal texture, this one is copied from vanilla
        public override string Texture => "TestContent/NPCs/KiryuPNG/Tiles/RelicPedestal";
