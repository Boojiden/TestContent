...
{
    public class MinosMusicBoxItem : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/MinosLoop"), ModContent.ItemType<MinosMusicBoxItem>(), ModContent.TileType<MinosMusicBoxTile>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<MinosMusicBoxTile>(), 0);
        }
    }
}
