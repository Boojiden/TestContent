...
namespace TestContent.Items.Pets.Luigi
{
    public class LuigiPetProjectile : ModProjectile
    {
        public int timeUntillJumpscare = 100;
        ...
        {
            timeUntillJumpscare = Main.rand.Next(18000, 36000);
        }
        ...
        public void DoJumpscare()
        {
            ...
            {
                int duration = Main.rand.Next(2, 60);
                var system = ModContent.GetInstance<LuigiJumpscareUISystem>();
                system.ShowMyUI(duration); 
            }
            ResetJumpscare();
        }
        ...
        public override void AI()
        {
            ...
            if (!player.dead && player.HasBuff(ModContent.BuffType<LuigiPetBuff>()))
            {
