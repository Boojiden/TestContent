...
{
    public class PingasMusicBox : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(255, 215, 191), Language.GetText("Mods.TestContent.Items.PingasMusicBoxItem.DisplayName"));
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<PingasMusicBoxItem>();
        }
